...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
  ...
  if (self) {
    ...
    [_backgroundView addSubview:_timeLabel];
      ...
      _encryptLabel= [[UILabel alloc] initWithFrame:CGRectMake(kCellPadding, kCellPadding, _backgroundView.frame.size.width - kCellPadding* 2 , kLabelHeight)];
      //_encryptLabel.text = @"密";
      [_encryptLabel setTextColor:[UIColor charcoalColor]];
      [_encryptLabel setFont:[UIFont systemFontOfSize:10]];
      [_encryptLabel setTextAlignment:NSTextAlignmentRight];
      [_backgroundView addSubview:_encryptLabel];
